...
<body>
   ...
   <div class="container">
      ...
      <div class="row">
        <?php 
            $query = "SELECT * FROM sanpham WHERE (MaLoai = 1 or MaLoai = 3 or MaLoai = 4) ORDER BY SoLuongBan DESC LIMIT 10";
            GetProducts($query); 
        ?>
      </div>
   </div>
   ...
   <div class="container">
      ...
      <div class="row">
      <?php 
            $query = "SELECT * FROM sanpham WHERE (MaLoai = 1 or MaLoai = 3 or MaLoai = 4) ORDER BY NgayNhap DESC LIMIT 10";
            GetProducts($query); 
        ?>
      </div>
   </div>
